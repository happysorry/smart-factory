...
public class AE {
    ...
    public static String discovery_mn(){
        ...
        mn = "http://192.168.99.101:666/~/mn-cse";
        return mn;
    }
    public static String discovery_mn2(){
        String mn = "";
    ...
    public static String sub_ae(String target , String cnt_name){
        try {
            ...
            try {
                ...
                String request = 
                "<m2m:sub xmlns:m2m=\"http://www.onem2m.org/xml/protocols\" rn=\"SUB\"><nu>http://140.116.247.73:1111/test</nu><nct>2</nct></m2m:sub>";
                out.write(request.toString().getBytes("UTF-8")); 
                out.flush();
                out.close();
                System.out.println(http.getResponseCode());
